...
public class Zebra_QL420plus {
    ...
    public void PrintDefaultText(boolean _orientacion, int _fuente, int _size, int _posX, int _espacioPre, int _espacioPos, String _data){
        this._lineaActual += _espacioPre;
        if(_orientacion){
            this._infImpresora  += "VT "+_fuente+" "+_size+" "+_posX+" "+this._lineaActual+" "+_data+"\r\n";
        }else{
            this._infImpresora  += "T "+_fuente+" "+_size+" "+_posX+" "+this._lineaActual+" "+_data+"\r\n";
        }
        this._lineaActual += _espacioPos;
    }


    public void SetCommand(String _command){
        this._infImpresora 	+= _command+"\r\n";
    }
